...
function contractors() {
	...
	$labels = array(
		'name'                  => _x( 'Contractors', 'Post Type General Contractors', 'text_domain' ),
		'singular_name'         => _x( 'Contractors', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Contractors', 'text_domain' ),
		'name_admin_bar'        => __( 'Contractors', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Contractors', 'text_domain' ),
		'add_new_item'          => __( 'Add Contractor', 'text_domain' ),
		'add_new'               => __( 'Add Contractor', 'text_domain' ),
		'new_item'              => __( 'Add Contractor', 'text_domain' ),
		'edit_item'             => __( 'Edit Contractor', 'text_domain' ),
		'update_item'           => __( 'update Contractor', 'text_domain' ),
        'view_item'             => __( 'View Contractor', 'text_domain' ),
        'set_featured_image'    => __( 'News Featured Image', 'textdomain' ),
	...
	register_post_type( 'contractors', $args );

}
add_action( 'init', 'contractors', 0 );

function works() {

	$labels = array(
		'name'                  => _x( 'Work', 'Post Type General Work', 'text_domain' ),
		...
		'new_item'              => __( 'Add Work', 'text_domain' ),
